...
class Rule:
    def __init__(self, rule, words, k1=0.8, k2=3):
        """
...
r = Rule('i want work', {'i': ['я', 'мне', 'меня'], 'want': ['хочу', 'хочется', 'желаю', 'желание'], 'work': ['работать', 'пахать', 'вкалывать', 'подметать', 'чистить']})
